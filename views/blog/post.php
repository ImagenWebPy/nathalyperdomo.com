                    ...
                    <div class="section_wrapper clearfix">
                        <div class="column one post-photo-wrapper">
                            <div class="post-photo">
                                <?php if (!empty($this->post['url_youtube'])): ?>
                                    <iframe class="scale-with-grid" src="http://www.youtube.com/embed/<?= $this->post['url_youtube']; ?>?wmode=opaque" allowfullscreen="" style="height: 413.6px;">
                                    </iframe>
